                ...
                <div class="p-3 bg-white rounded-lg">
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        @foreach ($availabilityByDay[$room->id] as $pcDay)
                            <a href="{{ route('pc-assignments-edit-day', ['pc' => $pcDay['pc']->id, 'day' => $selectedDay]) }}" class="bg-{{ $pcDay['isAvailable'] ? 'green' : 'red' }}-500 text-white font-bold text-center py-4 rounded-lg">
