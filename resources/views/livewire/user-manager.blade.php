    ...
    <div class="w-full px-4 mb-8">
        <form wire:submit.prevent="update" class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex space-x-4">
                <button type="submit" class="inline-block px-6 py-2 bg-indigo-600 text-white font-semibold rounded-md shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Update User</button>
                <button type="button" wire:click="delete({{ $user->id  }})" class="inline-block px-6 py-2 bg-red-600 text-white font-semibold rounded-md shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Delete</button>
